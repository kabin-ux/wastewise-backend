...
export const updateDriver = async (req, res, next) => {
    const { did } = req.params;
    const { firstName, lastName, dateOfBirth, email, address, phoneNumber, nationality, licenseNumber, password, confirmPassword } = req.body; // Ensure keys match schema


    try {
        const updateDriverData = { firstName, lastName, dateOfBirth, email, address, phoneNumber, nationality, licenseNumber, password, confirmPassword };
